...
parser.add_argument("--output", default="OSM_WizardZ", dest="testOutputDir",
                    help="Run with pre-defined options on file 'osm_bbox.osm.xml' and " +
                    "write output to the given directory.")
parser.add_argument("--city", default="xuzhou", help="Address for the city.")
...
if __name__ == "__main__":
    ...
    print(bbox)
    data = {'poly': True, 'duration': 3600, 'publicTransport': False, 'leftHand': False, 'vehicles': {'passenger': {'fringeFactor': 5, 'count': 12}}, 'coords': bbox, 'testOutputDir':args.testOutputDir }
